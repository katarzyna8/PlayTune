...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder2> {
    ...
    public ViewHolder2 onCreateViewHolder(@NonNull final ViewGroup viewGroup, int i) {
        final View itemView;
        itemView = layoutInflater.inflate(ListOfDiscsFragment.isGrid ? R.layout.card_layout_grid : R.layout.card_layout_of_disc, viewGroup, false);
